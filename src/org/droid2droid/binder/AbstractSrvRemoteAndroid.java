...
import static org.droid2droid.Constants.NOTIFY_NEW_APK;
import static org.droid2droid.Constants.PREFERENCES_KNOWN_ACCEPT_ALL;
import static org.droid2droid.Constants.START_PROGRESS_ACTIVITY_WHEN_DOWNLOAD_APK;
import static org.droid2droid.Constants.TAG_SERVER_BIND;
import static org.droid2droid.Constants.TIMEOUT_BETWEEN_SEND_FILE_DATA;
...
import org.droid2droid.install.AskAcceptDownloadApkActivity;
import org.droid2droid.install.DownloadApkActivity;
import org.droid2droid.install.InstallApkActivity;
import org.droid2droid.internal.AbstractProtoBufRemoteAndroid;
import org.droid2droid.internal.IRemoteAndroid;
import org.droid2droid.internal.Login;
import org.droid2droid.internal.NormalizeIntent;
   ...
   // Tools pour vérifier la signature. De toute facon, jette ensuite lors de l'installation si ca matche pas.
			...
			final long timeout) throws RemoteException
	{
		...
		try
		{
			...
			if (!packageName.matches("[a-z][a-z\\.0-9]+"))
...
//			mContext.getPackageManager().installPackage(Uri.fromFile(fileName), obs, flags, mContext.getPackageName());
		...
		else
		{
		    ...
		    try
		    {
			    Intent i=mContext.registerReceiver(packageListener, filter); // FIXME
