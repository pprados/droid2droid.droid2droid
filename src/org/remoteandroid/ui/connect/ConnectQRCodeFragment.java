...
public class ConnectQRCodeFragment extends AbstractConnectFragment implements SurfaceHolder.Callback, Wrapper
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		mSurfaceView = (SurfaceView) mViewer.findViewById(R.id.preview_view);
	...
	private void initCamera()
	{
		...
		{
			if (getActivity().getWindowManager().getDefaultDisplay().getWidth() < getActivity().getWindowManager()
